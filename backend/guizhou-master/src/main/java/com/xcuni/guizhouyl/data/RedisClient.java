...
public class RedisClient {
     ...
     *
     * @param key
     * @return result 执行 INCRBY 命令之后 key 的值。。
     */
...
time expire time in the units of {@param #expx}
    * */
    ...
    /**
     * 移除并返回列表 key 的尾元素。
     * brpop支持多个列表(队列),如List<String> messages = jedis.brpop(0, Producer.MESSAGE_KEY, "testKey");
